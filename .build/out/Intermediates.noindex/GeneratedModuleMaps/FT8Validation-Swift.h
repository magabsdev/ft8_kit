...
// Generated by Apple Swift version 6.4 (swiftlang-6.4.0.25.4 clang-2100.3.25.1)
#ifndef FT8VALIDATION_SWIFT_H
#define FT8VALIDATION_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="FT8Validation",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
