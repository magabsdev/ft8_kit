...
static const float db_power_sum[40] __attribute__((unused)) = {
...
static void __attribute__((unused)) ft8_decode_multi_symbols(const WF_ELEM_T* wf, int num_bins, int n_syms, int bit_idx, float* log174);
