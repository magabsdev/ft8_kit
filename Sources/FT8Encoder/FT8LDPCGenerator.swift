// Generated from the ft8_lib LDPC(174,91) generator matrix.
// Retained as packed bytes to preserve bit-for-bit parity with the reference encoder.
enum FT8LDPCGenerator {
    static let rows: [[UInt8]] = [
